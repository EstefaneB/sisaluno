...
<div class="box">
  ...
  <form method="POST" action="crudprof.php" >
    ...
    <div>
      ...
      <p>CPF: <br> <input type="text" name="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}"
            title="Digite o CPF no formato XXX.XXX.XXX-XX" id=""  value=<?php echo $cpf ?> ></p>

      <p>Status: <br> <select class="status1" name="estatus" id="" value=<?php echo $estatus ?> >
            <option value="1"> Ativado</option>
            <option value="0"> Desativado</option> </p>
