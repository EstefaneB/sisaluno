...
if (isset($_GET['cadastrar'])){
        ...
        ##codigo SQL
         $sql = "INSERT INTO disciplina(nomedisciplina,semestre,ch) 
                VALUES('$nomedisciplina','$semestre','$ch')";
...
if(isset($_POST['update'])){
    ...
    $ch = $_POST["ch"];
      ...
      ##codigo sql
    $sql = "UPDATE  disciplina SET nomedisciplina= :nomedisciplina, semestre= :semestre, ch= :ch WHERE id= :id ";
